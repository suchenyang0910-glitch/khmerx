...
OPENCLAW_WEBHOOK_ENABLED = os.getenv("OPENCLAW_WEBHOOK_ENABLED", "false").lower() == "true"
OPENCLAW_WEBHOOK_URL = os.getenv("OPENCLAW_WEBHOOK_URL", "")
OPENCLAW_WEBHOOK_SECRET = os.getenv("OPENCLAW_WEBHOOK_SECRET", "")
OPENCLAW_WEBHOOK_TIMEOUT_SECONDS = int(os.getenv("OPENCLAW_WEBHOOK_TIMEOUT_SECONDS", "12"))
...
SALARY_LOAN_WEBHOOK_SECRET = os.getenv("SALARY_LOAN_WEBHOOK_SECRET", "")
SALARY_LOAN_WEBHOOK_MAX_SKEW_SECONDS = int(os.getenv("SALARY_LOAN_WEBHOOK_MAX_SKEW_SECONDS", "300"))
